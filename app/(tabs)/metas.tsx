...
// Definindo o "formato" de um objeto de Meta para o TypeScript
type Meta = {
    id: string;
    titulo: string;
    descricao: string;
    progresso: number; // Um valor de 0 a 100
    vencimento: string; // Ex: "out 2025"
};
...
export default function MetasScreen() {
    ...
    const handleAddMeta = () => {
        ...
        const novaMeta: Meta = {
            ...
            progresso: Math.min(Math.max(progressoNumerico, 0), 100), // Garante que o progresso fique entre 0 e 100
        };
...
// Estilos para a tela de Metas
const styles = StyleSheet.create({
    safeArea: { flex: 1, backgroundColor: '#FFFFFF' },
    header: {
        backgroundColor: '#007BFF', // Um azul similar ao da imagem
    ...
    addButtonText: { color: 'white', fontSize: 28, fontWeight: 'bold', lineHeight: 32 },
    gridContainer: {
        flexDirection: 'row',
        flexWrap: 'wrap',
    ...
    card: {
        width: '46%', // Aproximadamente 2 por linha com um pequeno espaço
        ...
        minHeight: 180, // Altura mínima para consistência
        justifyContent: 'space-between',
    },
    ...
    // Estilos do Modal (reutilizados da tela Agenda)
    modalContainer: {
        flex: 1,
        justifyContent: 'center',
        alignItems: 'center',
